...
window.addEventListener("scroll", () => {
  ...
  if (brandwall) {
    ...
    if (brandwallCords.top <= brandwallCords.height) {
  ...
  if (footer) {
    ...
    if (footerCoords.top <= footerCoords.height) {
      footerString.style.transform = "translateX(-20%)";
    }
  }
  ...
  if (scrollTop > lastScrollTop) {
    ...
    if (bannerLineWorkYellow) {
      bannerLineWorkYellow.style.bottom = "-199px";
    }

    if (bannerLineWorkRed) {
      bannerLineWorkRed.style.bottom = "-283px";
    }
